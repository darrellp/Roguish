...
internal class GridConnections
{
    ...
    internal IEnumerable<ConnectionInfo> Connections
    {
        ...
        {
            // For each row
            for (var iRow = 0; iRow < _superGridHeight - 1; iRow++)
                // For each column
            ...
            for (var iRow = 0; iRow < _superGridHeight; iRow++)
                // For each column
            for (var iColumn = 0; iColumn < _superGridWidth - 1; iColumn++)
                yield return new ConnectionInfo(this, new Point(iColumn, iRow), Dir.Horiz,
                    _connectsRight[iColumn, iRow]);
        }
    }
    ...
    internal void ConnectCells()
    {
        ...
        while (unconnectedCellList.Count != 0)
        {
            ...
            if (unconnectedNeighbors.Count != 0)
            {
                ...
                var neighborIndex = _rng.NextInt(unconnectedNeighbors.Count);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    internal static void AddRandomConnections(int connectionCount, GridConnections connections)
    {
    ...
    private void MakeRandomConnection()
    {
        ...
        var connectionIndex = _rng.NextInt(_freeConnectionCount);
    ...
    {
        foreach (var info in Connections) info.SetValue(false);
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    private IEnumerable<Point> UnconnectedNeighbors(Point cellLocation)
    {
    ...
    internal struct ConnectionInfo(GridConnections connections, Point location, Dir dir, bool isConnected)
    {
        ...
        internal void SetValue(bool isConnectedNew)
        {
            ...
            if (isConnectedNew == IsConnected) return;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    private void ConnectVertical(int column, int higherRow)
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    private void ConnectHorizontal(int row, int leftmostColumn)
    {
